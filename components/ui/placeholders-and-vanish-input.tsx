...
export function PlaceholdersAndVanishInput({
  ...
  return (
    <form
      className={cn(
        "w-full relative max-w-xl mx-auto  bg-n-6 h-12 rounded-full overflow-hidden shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),_0px_1px_0px_0px_rgba(25,28,33,0.02),_0px_0px_0px_1px_rgba(25,28,33,0.08)] transition duration-200",
        value && "bg-n-5"
      )}
    ...
    >
      ...
      <button
        disabled={!value}
        type="submit"
        className="absolute right-2 top-1/2 z-50 -translate-y-1/2 h-8 w-8 rounded-full bg-n-8 disabled:bg-n-5 transition duration-200 flex items-center justify-center"
      >
        <motion.svg

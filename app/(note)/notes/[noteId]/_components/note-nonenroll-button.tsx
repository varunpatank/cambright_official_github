...
interface NoteNonEnrollButtonProps {
  noteId: string;
}
export const NoteNonEnrollButton = ({ noteId }: NoteNonEnrollButtonProps) => {
  ...
  const handleEnroll = async () => {
    try {
      setLoading(true);
      await axios.delete(`/api/notes/${noteId}/disenroll/`);
  ...
  return (
    <ConfirmModalEnroll
      ...
      additionalText={`Are you sure you want to disenroll from this note?`}

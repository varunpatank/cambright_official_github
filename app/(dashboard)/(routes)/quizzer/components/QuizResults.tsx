...
import { UserAnswer, GeneratedQuizQuestion } from '../types/quiz';
...
export function QuizResults({ answers, questions, onRestart, onHome }: QuizResultsProps) {
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="max-w-4xl mx-auto p-8">
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-bold mb-4 font-sora">Quiz Complete!</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          ...
          <div className="bg-gray-900 rounded-xl p-6 text-center">
            <div className="text-3xl font-bold text-blue-400 mb-2">{totalMarks}/{maxMarks}</div>
        ...
        <div className="bg-gray-900 rounded-xl p-6 mb-8">
          ...
          <div className="space-y-4">
            {questions.map((question, index) => {
              ...
              return (
                <div key={question.id} className="flex items-start justify-between p-4 bg-gray-800 rounded-lg">
                  <div className="flex items-start space-x-4 flex-1">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center space-x-3 mb-2">
                        ...
                        <div className="text-sm text-yellow-400 bg-gray-700 px-2 py-1 rounded">
                          {question.difficulty}
                        </div>
                      </div>
                      ...
                      {userAnswer.keywords && userAnswer.keywords.length > 0 && (
                        <div>
                          <div className="text-xs text-gray-400 mb-1">Key terms:</div>
                          <div className="flex flex-wrap gap-1">
                            {userAnswer.keywords.slice(0, 5).map((keyword, idx) => (
                              <span key={idx} className="bg-purple-900 text-purple-300 px-2 py-1 rounded text-xs">
                                {keyword}
                              </span>
                            ))}
                          </div>
        ...
        <div className="bg-gray-900 rounded-xl p-6 mb-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="text-center">
              <div className="text-2xl font-bold text-purple-400">{Math.round((correctAnswers / questions.length) * 100)}%</div>
        ...
        <div className="flex justify-center space-x-4">
          <button
            onClick={onRestart}
            className="flex items-center space-x-2 bg-purple-700 hover:bg-purple-800 px-6 py-3 rounded-lg font-medium transition-colors"
          >

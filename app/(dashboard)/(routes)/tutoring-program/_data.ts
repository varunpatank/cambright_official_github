...
export const COURSES: CourseData[] = [
  ...
  },
  {
    id: "physics-igcse",
    title: "Physics IGCSE",
    subtitle: "Practice FRQs by Vaishnav Bourempeta",
    author: "Vaishnav Bourempeta",
    authorTag: null,
    // TODO: set clerkUserId to Vaishnav's Clerk user ID once known
    clerkUserId: undefined,
    authorRole: "CIE IGCSE Physics Tutor",
    accentFrom: "#60a5fa",
    accentTo: "#2563eb",
    glowRgb: "96,165,250",
    image: "/physTH.png",
    chaptersCount: 2,
    tagLabel: "VIDEO COURSE",
    tagStyle: "bg-blue-500/20 text-blue-300 border-blue-400/40",
    shortDescription: "Two exam-style practice FRQ walkthroughs by Vaishnav — geometric optics, and electric fields & charges.",
  },
  {
    id: "math-0580-unit-2",
